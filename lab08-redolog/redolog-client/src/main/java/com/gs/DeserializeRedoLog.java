...
public class DeserializeRedoLog {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DeserializeRedoLog.class);
    ...
    protected void processSingleEntryData(IReplicationPacketEntryData data) throws IOException {
        ...
        else logger.warn("Unhandled replication packet type: {}", data);
    }
    ...
    protected void processTransactionData(IReplicationPacketData data) throws IOException {
    ...
    public void processPacket(IReplicationPacketData data) throws IOException {
