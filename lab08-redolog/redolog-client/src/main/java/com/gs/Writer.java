...
public class Writer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DistributedJiniTxManagerConfigurer txConfigurer = new DistributedJiniTxManagerConfigurer();
        ...
        GigaSpace gs = new GigaSpaceConfigurer(configurer).transactionManager(ptm).gigaSpace();
